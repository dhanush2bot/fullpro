...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
                    ...
                    if IS_VERIFY and not await check_verification(client, query.from_user.id):
                        ...
                        await client.send_cached_media(
                            ...
                            reply_markup=InlineKeyboardMarkup(
                                [
                                [
                                    InlineKeyboardButton('𝐑𝐄𝐐𝐔𝐄𝐒𝐓 𝐆𝐑𝐎𝐔𝐏', url=GRP_LNK),
                                    InlineKeyboardButton('𝐌𝐎𝐕𝐈𝐄 𝐂𝐇𝐀𝐍𝐍𝐄𝐋', url=SPRT_CHNL)
                                ],[
        ...
        buttons = [[
                    ...
                    InlineKeyboardButton('✪ 𝐉𝐎𝐈𝐍 𝐔𝐏𝐃𝐀𝐓𝐄 𝐂𝐇𝐀𝐍𝐍𝐄𝐋 ✪', callback_data="chnl_info")
                  ]]
        ...
        buttons = [[
            ...
            InlineKeyboardButton(' 𝐆𝐋𝐎𝐁𝐀𝐋 𝐅𝐈𝐋𝐓𝐄𝐑 ', callback_data='global_filters')
        ]]
        ...
        buttons = [[
            InlineKeyboardButton('⟸ 𝐁𝐀𝐂𝐊', callback_data='filters')
        ]]
        await client.edit_message_media(
            query.message.chat.id, 
            query.message.id, 
        ...
        buttons = [[
            InlineKeyboardButton('✉️ 𝐀𝐍𝐘 𝐐𝐔𝐄𝐑𝐘 ✉️', url='https://t.me/FilmySpotSupport_bot')
        ], [
            InlineKeyboardButton('∙ 𝐅𝐈𝐋𝐓𝐄𝐑𝐒 ∙', callback_data='filters'),
            InlineKeyboardButton('∙ 𝐅𝐈𝐋𝐄 𝐒𝐓𝐎𝐑𝐄 ∙', callback_data='store_file')
        ], [
            InlineKeyboardButton('∙ 𝐂𝐎𝐍𝐍𝐄𝐂𝐓𝐈𝐎𝐍 ∙', callback_data='coct'),
            InlineKeyboardButton('∙ 𝐄𝐗𝐓𝐑𝐀 𝐌𝐎𝐃𝐒 ∙', callback_data='extra')
        ], [
            InlineKeyboardButton('∙ 𝐑𝐔𝐋𝐄𝐒 ∙', callback_data='rule_btn'),
            InlineKeyboardButton('∙ 𝐒𝐄𝐓𝐓𝐈𝐍𝐆𝐒 ∙', callback_data='setting_btn')
        ], [
        ...
        buttons = [[
            InlineKeyboardButton('𝐄𝐗𝐓𝐑𝐀 𝐅𝐄𝐀𝐓𝐔𝐑𝐄𝐒', callback_data='mods')
        ],[ 
            InlineKeyboardButton('𝐎𝐖𝐍𝐄𝐑 𝐈𝐍𝐅𝐎', callback_data="owner_info"),
            InlineKeyboardButton('𝐒𝐎𝐔𝐑𝐂𝐄 𝐂𝐎𝐃𝐄', callback_data='source')
        ...
        buttons = [[
            InlineKeyboardButton('🖼️ 𝐓𝐄𝐋𝐄𝐆𝐑𝐀𝐏𝐇 🖼️', callback_data='tele')
        ],[
            InlineKeyboardButton('🎭 𝐒𝐓𝐈𝐂𝐊𝐄𝐑 𝐈𝐃 🎭', callback_data='sticker')
        ],[ 
            InlineKeyboardButton('📝 𝐅𝐎𝐍𝐓 𝐆𝐄𝐍𝐄𝐓𝐀𝐓𝐎𝐑 📝', callback_data='font')
        ],[
        ...
        buttons = [[
            InlineKeyboardButton('‹‹‹ 𝐁𝐀𝐂𝐊', callback_data='mods')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        await query.message.edit_text(
            ...
            btn = [[
                    InlineKeyboardButton("⟸ 𝐁𝐀𝐂𝐊", callback_data="start"),
                    InlineKeyboardButton("𝐂𝐎𝐍𝐓𝐀𝐂𝐓", url="https://t.me/FilmySpotSupport_bot")
                  ]]
            await client.edit_message_media(
                query.message.chat.id, 
                query.message.id, 
            ...
            btn = [[
                    InlineKeyboardButton("𝐌𝐎𝐕𝐈𝐄 𝐑𝐄𝐐𝐔𝐄𝐒𝐓 𝐆𝐑𝐎𝐔𝐏", url= GRP_LNK)
                ],[
                    InlineKeyboardButton(" 𝐌𝐎𝐕𝐈𝐄 𝐂𝐇𝐀𝐍𝐍𝐄𝐋  ", url=SPRT_CHNL)
                ],[
                    InlineKeyboardButton(" 𝐔𝐏𝐃𝐀𝐓𝐄 𝐂𝐇𝐀𝐍𝐍𝐄𝐋 ", url=CHNL_LNK)
                ],[
                    InlineKeyboardButton('𝐇𝐎𝐌𝐄', callback_data='start'),
                    InlineKeyboardButton(' 𝐂𝐋𝐎𝐒𝐄 ', callback_data='close_data')
                ]]
        ...
        await query.message.edit_text(
            ...
            btn = [[
                    InlineKeyboardButton("⟸ 𝐁𝐀𝐂𝐊", callback_data="start"),
                    InlineKeyboardButton("𝐂𝐎𝐍𝐓𝐀𝐂𝐓", url="telegram.me/Tg_support1_bot")
                  ]]
            await client.edit_message_media(
                query.message.chat.id, 
                query.message.id, 
